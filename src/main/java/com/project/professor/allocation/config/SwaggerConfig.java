...
import com.project.professor.allocation.ProfessorAllocationRonaldosiqueiraApplication;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors
						.basePackage(ProfessorAllocationRonaldosiqueiraApplication.class.getPackage().getName()))
